...
SECRET_KEY = 'o$_6!jbq5tyj9uzg42r=a+y5_eb^511y95+t31$ib1uj&9l+$l'
...
INSTALLED_BACKENDS = {
    ...
    "rocket": {
        "ENGINE": "rapidsms.backends.Rocket.RocketBackend",
    },
}
...
RAPIDSMS_HANDLERS = (
    #"rapidsms.contrib.handlers.KeywordHandler", NEVER DO THIS!
    #"rapidsms.contrib.handlers.PatternHandler", NEVER DO THIS!
    #'rapidsms.contrib.echo.handlers.echo.EchoHandler',
    "myhandlers.HelpHandler",
    "myhandlers.LightHandler",
